...
if TYPE_CHECKING:
    from applications.api.nico_rate.client import NicoRateClient


class TestNicoRate(BaseAPITest):
    """
    Test suite for the Nico Rate API.
    """
    ...
    @test_case(id="RATE-001")
    def test_complete_flow(self):
        """Verify the complete flow: Search -> Get Policies."""
        self._run_full_flow("RATE-001")
