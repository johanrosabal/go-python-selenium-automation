...
class NifisEndpoint(BaseEndpoint):
    """
    Endpoint for Nifis Policy Search and Results.
    """
    ...
    def get_policies(self, search_id):
        """
        Retrieves policies for a given search ID.
        GET /policy-search/{id}/policies
        """
        return (
            self.get.set_url(self.base_url)
            .set_endpoint("/policy-search/{id}/policies")
