...
if TYPE_CHECKING:
    from applications.api.nico_nifis.client import NicoNifisClient


class TestNicoNifis(BaseAPITest):
    """
    Test suite for the Nico Nifis API.
    """

    app: "NicoNifisClient"
    app_name = "nico_nifis"

    def _run_full_flow(self, test_id=None):
    ...
    @test_case(id="NIFIS-001")
    def test_complete_flow(self):
        """Verify the complete flow: Search -> Get Policies."""
        self._run_full_flow("NIFIS-001")
