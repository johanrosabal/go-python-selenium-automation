...
if TYPE_CHECKING:
    from applications.api.nico_gls.client import NicoGlsClient


class TestNicoGls(BaseAPITest):
    """
    Test suite for the Nico Gls API.
    """
